    ...
    <main id="top" className="overflow-x-hidden">
      ...
      <section className="relative min-h-[100svh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-6 pb-16 pt-28 md:justify-center md:px-8 md:pb-24">
          <div className="max-w-xl">
            <h1 className="font-display animate-fade-up text-5xl font-bold tracking-[0.22em] text-white sm:text-6xl md:text-7xl">
              FLEET
            </h1>
        ...
        <div className="mx-auto max-w-6xl px-6 md:px-8">
          ...
          <div className="mt-14 grid gap-0 border border-fog md:grid-cols-2">
            <div className="border-b border-fog p-8 md:border-b-0 md:border-r md:p-10">
              ...
              <ul className="font-display mt-6 space-y-4 text-2xl font-semibold text-ink-soft/70 md:text-3xl">
                <li>1 Truck</li>
                <li>2–10 Workers</li>
            ...
            <div className="bg-teal/[0.06] p-8 md:p-10">
              ...
              <ul className="font-display mt-6 space-y-4 text-2xl font-semibold text-ink md:text-3xl">
                <li>1 Truck</li>
                <li>1 Operator</li>
      ...
      <section id="product" className="bg-ink py-24 md:py-32">
        <div className="mx-auto max-w-6xl px-6 md:px-8">
          ...
          <div className="relative mt-12 aspect-[16/10] overflow-hidden bg-ink-soft md:aspect-[21/10]">
            ...
            <p className="absolute bottom-6 left-6 right-6 font-display text-sm font-semibold tracking-[0.14em] text-white/80 uppercase md:bottom-8 md:left-8">
          ...
          <div className="mt-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {roles.map((unit, i) => (
              <div key={unit.name} className="border-t border-white/15 pt-6">
                <span className="font-display text-xs font-bold tracking-widest text-steel">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <h3 className="font-display mt-2 text-xl font-bold text-paper">
                  {unit.name}
                </h3>
      ...
      <section id="markets" className="bg-ink">
        <div className="mx-auto max-w-6xl border-t border-white/10 px-6 py-24 md:px-8 md:py-32">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display mt-3 text-3xl font-bold tracking-tight text-paper md:text-5xl text-balance">
            ...
            >
              ...
              >
                <div className="max-w-md">
                  <p className="font-display text-xs font-bold tracking-[0.2em] text-teal-bright uppercase">
                    {String(i + 1).padStart(2, "0")}
                  </p>
                  <h3 className="font-display mt-3 text-3xl font-bold text-paper md:text-4xl">
                    {market.title}
                  </h3>
          ...
          <div className="mt-14 grid gap-x-10 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
            {fleetOsLayers.map((layer, i) => (
              <div key={layer.title} className="border-t border-fog pt-6">
                ...
                <h3 className="font-display mt-2 text-lg font-bold text-ink">{layer.title}</h3>
      ...
      <section className="bg-paper py-24 md:py-32">
        <div className="mx-auto max-w-6xl px-6 md:px-8">
          ...
          <h2 className="font-display mt-3 max-w-2xl text-3xl font-bold tracking-tight text-ink md:text-5xl text-balance">
          ...
          <div className="mt-14 grid gap-10 md:grid-cols-2 md:gap-16">
            <div>
              ...
              <p className="font-display mt-4 text-3xl font-bold leading-tight text-ink-soft md:text-4xl">
                One robot.
                <br />
                One industry.
                <br />
            ...
            <div>
              ...
              <p className="font-display mt-4 text-3xl font-bold leading-tight text-ink md:text-4xl">
                One platform.
                <br />
                Multiple industries.
                <br />
      ...
      <section id="contact" className="border-t border-fog bg-paper py-20 md:py-24">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 md:flex-row md:items-end md:justify-between md:px-8">
          <div>
            <p className="font-display text-sm font-bold tracking-[0.22em] text-teal uppercase">
              FLEET
            </p>
      ...
      <footer className="border-t border-ink-soft/30 bg-ink px-6 py-8 md:px-8">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-display text-sm font-bold tracking-[0.28em] text-paper">
            FLEET
          </p>
